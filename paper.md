...
# Available Methods
The LCIA formatter is structured to easily convert original source data from existing LCIA methods. Version 1.0 of the LCIA formatter converts three commonly used LCIA methods: TRACI 2.1, ReCiPe2016, and ImpactWorld+ \autoref{tbl:methods}. Available LCIA methods cover a variety of impact categoriesCumulative LCI indicators based on the FEDEFL are also available as an output of the LCIA formatter.
...
: Impact methods procesed by lciafmt.\label{tbl:methods}
