...
## ImpactWorld+ - Ben M
[@bulle_impact_2019]
2-3 sentences on instances where mapping is not 1:1 (e.g., excludes regionalization) and include original source citation. Regionalized flowables are excluded
